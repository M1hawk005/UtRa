...
All of these use the current base version of AT-HYG (v3.3), which in turn used HYG 4.2 for the HYG data properties.
...
#### athyg_33_reduced_m11.csv: AT-HYG v3.3 to magnitude 11 (871,139 stars)

This subset contains all AT-HYG stars to V (for HIP and Gliese) or VT (for Tycho-2) magnitude +11.0.

#### athyg_33_reduced_m10.csv: AT-HYG v3.3 to magnitude 10 (330,327 stars)

This subset contains all AT-HYG stars to V (for HIP and Gliese) or VT (for Tycho-2) magnitude +10.0. 

#### athyg_33_classic_ids.csv: AT-HYG v3.3 stars with 'classic' names and IDs (317,175 stars)
...
#### athyg_33_hyg_ids.csv: AT-HYG v3.3 stars with HYG IDs (118,971 stars)
...
Since this is a subset of AT-HYG, it inherits the data improvements from Gaia that characterize AT-HYG and distinguish it from the original HYG. For example, just under 90% of stars in HYG v3.x have Gaia DR3 distance data in AT-HYG v3.3, and thus also in this subset of AT-HYG data. 

### HYG Data Schema

These use the same column names and (with a few minor exceptions, noted below) the same data values as the HYG catalog (v4.x).

#### hyglike_from_athyg_v33.csv: HYGLike v3.3 (all HYG stars in AT-HYG) (118,971 stars)
